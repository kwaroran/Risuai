export const languageChinese = {
    ...
    "help": {
        ...
        "largeChatPerformanceMode": "用于超长聊天的实验性显示优化。均衡模式会合并流式 UI 更新；强模式还会在生成完成前以原始文本显示当前流式消息。关闭会保留现有行为和热路径日志。",
    ...
    "largeChatPerformanceMode": "长聊天性能模式",
    "largeChatPerformanceOff": "关闭",
    "largeChatPerformanceBalanced": "均衡",
    "largeChatPerformanceStrong": "强",
    "altGreet": "备选初始消息",
    "scripts": "脚本",
    "settings": "设置",
    "selective": "选择性",

export const languageGerman = {
    ...
    "help": {
        ...
        "openAIFlexProcessing": "OpenAI Flex-Antworten können langsamer sein als normale Antworten, sind aber günstiger (Batch-API-Preis). Dieser Schalter gilt nur für offizielle OpenAI Chat Completions- und Responses API-Anfragen.",

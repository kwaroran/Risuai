export const languageGerman = {
    ...
    webuiApiFlagWarning: "Sie müssen WebUI mit dem --api Flag verwenden",
    webuiAgplWarning: "Sie müssen WebUI ohne AGPL-Lizenz verwenden oder eine unveränderte Version mit AGPL-Lizenz nutzen, um den Inhalt der AGPL-Lizenz einzusehen.",
    webVersionTunnelWarning: "Sie verwenden die Webversion. Um Ihre lokale WebUI zu nutzen, müssen Sie ngrok oder andere Tunnel verwenden.",
    comfyCorsHeaderWarning: "\"Bitte führen Sie comfyUI mit --enable-cors-header aus.\"",
    comfyFirstImageNote: "Das erste vom Prompt generierte Bild wird ausgewählt.",
    leaveBlankForDefaultImage: "Leer lassen, um das Standardbild des Charakters zu verwenden.",
    useCharacterDefaultImage: "Standardbild des Charakters verwenden.",
    modelImageInputUnsupported: "Das Modell unterstützt keine Bildeingabe. Oder aktualisieren Sie die Modellliste, um den Modellstatus zu aktualisieren.",
    selectAModel: "Modell auswählen...",
    notAllowed: "Nicht erlaubt",
    ttsAutoImportWarning: "Wenn es nicht auf Auto eingestellt ist, funktioniert es möglicherweise nicht richtig beim Import aus einem anderen Betriebssystem oder Browser.",
    elevenLabsKeyLocationHint: "Bitte legen Sie den ElevenLabs API-Schlüssel unter \"Globale Einstellungen → Bot-Einstellungen → Andere → ElevenLabs API-Schlüssel\" fest",
    modelFetchError: "Beim Abrufen der Modelle ist ein Fehler aufgetreten.",
    realmLoginRequired: "Sie müssen sich bei einem Risu-Konto anmelden, um zu RisuRealm hochzuladen",
    realmLoginHint: "Sie können sich in den App-Einstellungen 🡲 Konto anmelden",
    realmCreatorNotesDesc: "Eine Beschreibung, die bei der Suche und beim ersten Öffnen eines Bots angezeigt wird.",
    realmCreatorNotesLengthHint: "Mehr als 20 Zeichen.",
    realmTagsDesc: "Tags, um Ihren Charakter leicht zu finden. nur lateinische Buchstaben. durch Kommas getrennt.",
    realmLicenseDesc: "Sie können eine Lizenz für Downloader wählen, um die Nutzung des Prompts Ihrer Karte einzuschränken.",
    welcomeToRisuai: "Willkommen bei Risuai!",
    selectBotToStartChatting: "Wählen Sie einen Bot, um mit dem Chatten zu beginnen",
    tokenEstimateDisclaimer: "Dies ist eine Schätzung. Die tatsächliche Tokenanzahl kann abweichen.",
    irisTypingIndicator: "Iris schreibt",
    promptDiffCardsChanged: "Geänderte Karten:",
    promptDiffNoBodyContent: "Kein Body-Inhalt",
    promptDiffNotComputedYet: "Noch kein Diff berechnet.",
    promptDiffNoChanges: "Keine Änderungen",

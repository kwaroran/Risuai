export const languageGerman = {
    ...
    patchNotes: {
        title: "Patchnotes",
        previousTitle: "Frühere Patchnotes",
        viewPrevious: "Patchnotes früherer Versionen anzeigen",
        back: "Zurück",
        backToList: "Zurück zur Versionsliste",
        loading: "Patchnotes werden geladen...",
        loadError: "Diese Patchnotes konnten nicht geladen werden.",
        listError: "Die Release-Liste konnte nicht geladen werden.",
        retry: "Erneut versuchen",
        empty: "Es gibt keine weiteren Releases.",
        noContent: "Für dieses Release wurden keine Patchnotes angegeben.",
        previousPage: "Zurück",
        nextPage: "Weiter",

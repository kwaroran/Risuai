export const languageEnglish = {
    ...
    help: {
        ...
        sideMenuEmbedding:
            "An independent Markdown/HTML display shown on the right side of the chat screen. When its content changes, it updates while preserving existing DOM elements as much as possible.\n\nMost state is preserved automatically. If you especially want to keep the state of a particular element, give it a unique attribute value so it can be distinguished from other elements.\n\n```html\n<div data-id=\"status-panel\">...</div>\n```",
    ...
    sideMenuEmbedding: "Side Panel Embedding",
    copied: "Copied",

export const languageEnglish = {
    ...
    // Hardcoded UI string extractions
    webuiApiFlagWarning: "You must use WebUI with --api flag",
    webuiAgplWarning: "You must use WebUI without agpl license or use unmodified version with agpl license to observe the contents of the agpl license.",
    webVersionTunnelWarning: "You are using web version. you must use ngrok or other tunnels to use your local webui.",
    comfyCorsHeaderWarning: "\"Please run comfyUI with --enable-cors-header.\"",
    comfyFirstImageNote: "The first image generated by the prompt will be selected.",
    leaveBlankForDefaultImage: "Leave blank to use the character's default image.",
    useCharacterDefaultImage: "Use the character's default image.",
    modelImageInputUnsupported: "Model does not support image input. Or refresh model list to update model status.",
    selectAModel: "Select a model...",
    notAllowed: "You are not allowed",
    ttsAutoImportWarning: "If you do not set it to Auto, it may not work properly when importing from another OS or browser.",
    elevenLabsKeyLocationHint: "Please set the ElevenLabs API key in \"global Settings → Bot Settings → Others → ElevenLabs API key\"",
    modelFetchError: "An error occurred while fetching the models.",
    realmLoginRequired: "You must login to Risu Account upload to RisuRealm",
    realmLoginHint: "You can login in app settings 🡲 account",
    realmCreatorNotesDesc: "A description that displays when you search and when you first open a bot.",
    realmCreatorNotesLengthHint: "More than 20 characters.",
    realmTagsDesc: "Tags to search your character easily. latin alphabets only. seperate by comma.",
    realmLicenseDesc: "You can choose license for the downloaders to limit the usages of your card's prompt.",
    welcomeToRisuai: "Welcome to Risuai!",
    selectBotToStartChatting: "Select a bot to start chatting",
    tokenEstimateDisclaimer: "This is a estimate. The actual token count may be different.",
    irisTypingIndicator: "Iris is typing",
    promptDiffCardsChanged: "Cards changed:",
    promptDiffNoBodyContent: "No body content",
    promptDiffNotComputedYet: "No diff computed yet.",
    promptDiffNoChanges: "No changes",

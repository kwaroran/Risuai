export const languageSpanish = {
    ...
    "help": {
        ...
        "largeChatPerformanceMode": "Optimización experimental de visualización para chats muy largos. Equilibrado agrupa las actualizaciones de UI en streaming; Fuerte también muestra el mensaje activo como texto sin procesar hasta que termine. Desactivado conserva el comportamiento y los logs de hot path actuales.",
    ...
    "largeChatPerformanceMode": "Modo de rendimiento para chats largos",
    "largeChatPerformanceOff": "Desactivado",
    "largeChatPerformanceBalanced": "Equilibrado",
    "largeChatPerformanceStrong": "Fuerte",

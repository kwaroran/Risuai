export const languageSpanish = {
    ...
    patchNotes: {
        ...
        previousTitle: "Notas de parches anteriores",
        viewPrevious: "Ver notas de versiones anteriores",
        back: "Volver",
        backToList: "Volver a la lista de versiones",
        loading: "Cargando notas del parche...",
        loadError: "No se pudieron cargar estas notas del parche.",
        listError: "No se pudo cargar la lista de versiones.",
        retry: "Reintentar",
        empty: "No hay más versiones.",
        noContent: "Esta versión no incluye notas del parche.",

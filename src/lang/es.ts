export const languageSpanish = {
    ...
    webuiApiFlagWarning: "Debes usar WebUI con la opción --api",
    webuiAgplWarning: "Debes usar WebUI sin licencia agpl o usar una versión sin modificar con licencia agpl para observar el contenido de la licencia agpl.",
    webVersionTunnelWarning: "Estás usando la versión web. debes usar ngrok u otros túneles para usar tu webui local.",
    comfyCorsHeaderWarning: "\"Por favor, ejecuta comfyUI con --enable-cors-header.\"",
    comfyFirstImageNote: "Se seleccionará la primera imagen generada por el prompt.",
    leaveBlankForDefaultImage: "Deja en blanco para usar la imagen predeterminada del personaje.",
    useCharacterDefaultImage: "Usar la imagen predeterminada del personaje.",
    modelImageInputUnsupported: "El modelo no admite entrada de imagen. O actualiza la lista de modelos para actualizar el estado del modelo.",
    selectAModel: "Selecciona un modelo...",
    notAllowed: "No tienes permiso",
    ttsAutoImportWarning: "Si no lo configuras en Auto, es posible que no funcione correctamente al importar desde otro sistema operativo o navegador.",
    elevenLabsKeyLocationHint: "Configura la clave API de ElevenLabs en \"Ajustes globales → Ajustes del Bot → Otros → Clave API de ElevenLabs\"",
    modelFetchError: "Ocurrió un error al obtener los modelos.",
    realmLoginRequired: "Debes iniciar sesión en tu cuenta de Risu para subir a RisuRealm",
    realmLoginHint: "Puedes iniciar sesión en los ajustes de la app 🡲 cuenta",
    realmCreatorNotesDesc: "Una descripción que se muestra cuando buscas y cuando abres un bot por primera vez.",
    realmCreatorNotesLengthHint: "Más de 20 caracteres.",
    realmTagsDesc: "Etiquetas para buscar tu personaje fácilmente. solo alfabeto latino. separadas por comas.",
    realmLicenseDesc: "Puedes elegir una licencia para que quienes descarguen limiten el uso del prompt de tu tarjeta.",
    welcomeToRisuai: "¡Bienvenido a Risuai!",
    selectBotToStartChatting: "Selecciona un bot para empezar a chatear",
    tokenEstimateDisclaimer: "Esta es una estimación. El recuento real de tokens puede ser diferente.",
    irisTypingIndicator: "Iris está escribiendo",
    promptDiffCardsChanged: "Tarjetas modificadas:",
    promptDiffNoBodyContent: "Sin contenido en el cuerpo",
    promptDiffNotComputedYet: "Aún no se ha calculado ninguna diferencia.",
    promptDiffNoChanges: "Sin cambios",

export const languageKorean = {
    ...
    "help": {
        ...
        "sideMenuEmbedding": "채팅 화면 오른쪽에 표시되는 독립적인 마크다운/HTML 화면입니다. 내용이 변경되어도 최대한 기존 DOM 요소를 유지하면서 갱신합니다.\n\n대부분의 상태는 별도 설정 없이 유지됩니다. 그중 특정 요소의 상태를 계속 유지하고 싶다면, 다른 요소와 구분할 수 있도록 중복되지 않는 속성 값을 지정하세요.\n\n```html\n<div data-id=\"status-panel\">...</div>\n```",

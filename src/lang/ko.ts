export const languageKorean = {
    ...
    "help": {
        ...
        "largeChatPerformanceMode": "토큰이 아주 많은 채팅을 위한 실험적 표시 최적화입니다. 균형은 스트리밍 UI 갱신을 묶어서 처리하고, 강함은 생성 중인 메시지를 완료 전까지 원문 텍스트로 표시합니다. 끄기는 기존 동작과 hot path 로그를 그대로 유지합니다.",
    ...
    "largeChatPerformanceMode": "긴 채팅 성능 모드",
    "largeChatPerformanceOff": "끄기",
    "largeChatPerformanceBalanced": "균형",
    "largeChatPerformanceStrong": "강함",
    "altGreet": "추가 첫 메시지",
    "scripts": "스크립트",
    "settings": "설정",
    "selective": "멀티플 키",

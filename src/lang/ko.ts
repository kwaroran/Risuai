export const languageKorean = {
    ...
    patchNotes: {
        title: "패치노트",
        previousTitle: "이전 버전 패치노트",
        viewPrevious: "이전 버전 패치노트 보기",
        back: "뒤로",
        backToList: "버전 목록으로 돌아가기",
        loading: "패치노트를 불러오는 중...",
        loadError: "이 버전의 패치노트를 불러오지 못했습니다.",
        listError: "릴리즈 목록을 불러오지 못했습니다.",
        retry: "다시 시도",
        empty: "더 이상 표시할 릴리즈가 없습니다.",
        noContent: "이 릴리즈에는 작성된 패치노트가 없습니다.",
        previousPage: "이전",
        nextPage: "다음",

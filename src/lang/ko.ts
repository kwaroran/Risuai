export const languageKorean = {
    ...
    webuiApiFlagWarning: "--api 플래그와 함께 WebUI를 사용해야 합니다",
    webuiAgplWarning: "AGPL 라이선스 내용을 확인하려면 AGPL 라이선스가 없는 WebUI를 사용하거나, 수정되지 않은 버전에 AGPL 라이선스를 적용해서 사용해야 합니다.",
    webVersionTunnelWarning: "웹 버전을 사용 중입니다. 로컬 WebUI를 사용하려면 ngrok 등의 터널을 사용해야 합니다.",
    comfyCorsHeaderWarning: "\"comfyUI를 --enable-cors-header 플래그와 함께 실행해 주세요.\"",
    comfyFirstImageNote: "프롬프트로 생성된 첫 번째 이미지가 선택됩니다.",
    leaveBlankForDefaultImage: "캐릭터의 기본 이미지를 사용하려면 비워 두세요.",
    useCharacterDefaultImage: "캐릭터의 기본 이미지를 사용합니다.",
    modelImageInputUnsupported: "모델이 이미지 입력을 지원하지 않습니다. 모델 목록을 새로고침하여 모델 상태를 업데이트해 주세요.",
    selectAModel: "모델 선택...",
    notAllowed: "허용되지 않습니다",
    ttsAutoImportWarning: "Auto로 설정하지 않으면 다른 OS나 브라우저에서 가져올 때 제대로 작동하지 않을 수 있습니다.",
    elevenLabsKeyLocationHint: "\"전역 설정 → 봇 설정 → 기타 → ElevenLabs API 키\"에서 ElevenLabs API 키를 설정해 주세요",
    modelFetchError: "모델을 가져오는 중 오류가 발생했습니다.",
    realmLoginRequired: "RisuRealm에 업로드하려면 Risu 계정에 로그인해야 합니다",
    realmLoginHint: "앱 설정 🡲 계정에서 로그인할 수 있습니다",
    realmCreatorNotesDesc: "검색 시와 봇을 처음 열 때 표시되는 설명입니다.",
    realmCreatorNotesLengthHint: "20자 이상.",
    realmTagsDesc: "캐릭터를 쉽게 검색하기 위한 태그입니다. 영어 소문자만 가능하며 쉼표로 구분하세요.",
    realmLicenseDesc: "다운로더의 카드 프롬프트 사용 범위를 제한할 라이선스를 선택할 수 있습니다.",
    welcomeToRisuai: "Risuai에 오신 것을 환영합니다!",
    selectBotToStartChatting: "채팅을 시작할 봇을 선택해 주세요",
    tokenEstimateDisclaimer: "이는 추정치이며 실제 토큰 수와 다를 수 있습니다.",
    irisTypingIndicator: "Iris가 입력 중입니다",
    promptDiffCardsChanged: "변경된 카드:",
    promptDiffNoBodyContent: "본문 내용 없음",
    promptDiffNotComputedYet: "아직 차이점이 계산되지 않았습니다.",
    promptDiffNoChanges: "변경 사항 없음",

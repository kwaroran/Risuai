export const languageVietnamese = {
    ...
    patchNotes: {
        ...
        previousTitle: "Ghi chú bản vá trước đây",
        viewPrevious: "Xem ghi chú bản vá phiên bản trước",
        back: "Quay lại",
        backToList: "Quay lại danh sách phiên bản",
        loading: "Đang tải ghi chú bản vá...",
        loadError: "Không thể tải ghi chú bản vá này.",
        listError: "Không thể tải danh sách bản phát hành.",
        retry: "Thử lại",
        empty: "Không còn bản phát hành nào.",
        noContent: "Bản phát hành này không có ghi chú bản vá.",
        previousPage: "Trước",
        nextPage: "Tiếp",

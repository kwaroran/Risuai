export const languageVietnamese = {
    ...
    "help": {
        ...
        "largeChatPerformanceMode": "Tối ưu hiển thị thử nghiệm cho cuộc trò chuyện rất dài. Cân bằng sẽ gom các cập nhật UI khi streaming; Mạnh cũng hiển thị tin nhắn đang streaming dưới dạng văn bản thô cho đến khi hoàn tất. Tắt giữ nguyên hành vi và log hot path hiện tại.",
    ...
    "largeChatPerformanceMode": "Chế độ hiệu suất chat dài",
    "largeChatPerformanceOff": "Tắt",
    "largeChatPerformanceBalanced": "Cân bằng",
    "largeChatPerformanceStrong": "Mạnh",

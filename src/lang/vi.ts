export const languageVietnamese = {
    ...
    webuiApiFlagWarning: "Bạn phải sử dụng WebUI với cờ --api",
    webuiAgplWarning: "Bạn phải sử dụng WebUI không có giấy phép agpl hoặc sử dụng phiên bản chưa sửa đổi kèm giấy phép agpl để xem nội dung của giấy phép agpl.",
    webVersionTunnelWarning: "Bạn đang dùng phiên bản web. Để dùng WebUI cục bộ, bạn phải dùng ngrok hoặc đường hầm khác.",
    comfyCorsHeaderWarning: "\"Vui lòng chạy comfyUI với --enable-cors-header.\"",
    comfyFirstImageNote: "Hình ảnh đầu tiên được tạo bởi prompt sẽ được chọn.",
    leaveBlankForDefaultImage: "Để trống để dùng hình ảnh mặc định của nhân vật.",
    useCharacterDefaultImage: "Dùng hình ảnh mặc định của nhân vật.",
    modelImageInputUnsupported: "Mô hình không hỗ trợ nhập hình ảnh. Hoặc làm mới danh sách mô hình để cập nhật trạng thái mô hình.",
    selectAModel: "Chọn một mô hình...",
    notAllowed: "Bạn không được phép",
    ttsAutoImportWarning: "Nếu không đặt thành Auto, có thể không hoạt động đúng khi nhập từ hệ điều hành hoặc trình duyệt khác.",
    elevenLabsKeyLocationHint: "Vui lòng đặt khóa API ElevenLabs trong \"Cài đặt chung → Cài đặt Bot → Khác → Khóa API ElevenLabs\"",
    modelFetchError: "Đã xảy ra lỗi khi tải các mô hình.",
    realmLoginRequired: "Bạn phải đăng nhập Tài khoản Risu để tải lên RisuRealm",
    realmLoginHint: "Bạn có thể đăng nhập trong cài đặt ứng dụng 🡲 tài khoản",
    realmCreatorNotesDesc: "Mô tả hiển thị khi bạn tìm kiếm và khi lần đầu mở bot.",
    realmCreatorNotesLengthHint: "Nhiều hơn 20 ký tự.",
    realmTagsDesc: "Thẻ để dễ dàng tìm kiếm nhân vật của bạn. chỉ chữ cái latin. phân tách bằng dấu phẩy.",
    realmLicenseDesc: "Bạn có thể chọn giấy phép cho người tải xuống để giới hạn việc sử dụng prompt của thẻ.",
    welcomeToRisuai: "Chào mừng đến với Risuai!",
    selectBotToStartChatting: "Chọn một bot để bắt đầu trò chuyện",
    tokenEstimateDisclaimer: "Đây là ước tính. Số token thực tế có thể khác.",
    irisTypingIndicator: "Iris đang nhập",
    promptDiffCardsChanged: "Thẻ đã thay đổi:",
    promptDiffNoBodyContent: "Không có nội dung phần thân",
    promptDiffNotComputedYet: "Chưa tính toán sự khác biệt.",
    promptDiffNoChanges: "Không có thay đổi",

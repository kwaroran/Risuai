export const languageChineseTraditional = {
    ...
    "help": {
        ...
        "largeChatPerformanceMode": "用於超長對話的實驗性顯示最佳化。均衡模式會合併串流 UI 更新；強模式還會在生成完成前以原始文字顯示目前串流訊息。關閉會保留現有行為與 hot path 日誌。",
    ...
    "largeChatPerformanceMode": "長對話效能模式",
    "largeChatPerformanceOff": "關閉",
    "largeChatPerformanceBalanced": "均衡",
    "largeChatPerformanceStrong": "強",

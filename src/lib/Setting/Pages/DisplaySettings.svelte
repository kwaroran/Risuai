<script lang="ts">
    ...
    import { displayThemeItems, displaySizeItems, displayOthersItems } from "src/ts/setting/displaySettingsData";
...
{#if submenu === 0 || submenu === -1}
    <SettingRenderer items={displayThemeItems} />
{/if}

{#if submenu === 1 || submenu === -1}
    <SettingRenderer items={displaySizeItems} />
{/if}

{#if submenu === 2 || submenu === -1}
    <SettingRenderer items={displayOthersItems} />
{/if}